package com.conchoback.haingon.core.custom.drawview
...
import com.conchoback.haingon.data.model.draw.DrawDraw
import com.conchoback.haingon.data.model.draw.DrawableDraw
import com.conchoback.haingon.data.model.draw.TextDraw
import com.conchoback.haingon.listener.listenerdraw.BitmapDrawIcon
import com.conchoback.haingon.listener.listenerdraw.DeleteEvent
import com.conchoback.haingon.listener.listenerdraw.EditEvent
import com.conchoback.haingon.listener.listenerdraw.FlipEvent
import com.conchoback.haingon.listener.listenerdraw.OnDrawListener
import com.conchoback.haingon.listener.listenerdraw.ZoomEvent
        ...
        if (handlingDraw != null && !isLocked && (isShowBorder || isShowIcons)) {
            ...
            if (isShowIcons) {
                ...
                for (i in 0 until iconList.size) {
                    ...
                    else if (icon.positionDefault == DrawKey.BOTTOM_LEFT) {
...
//                        icon.draw(canvas, borderPaint)
    ...
    private fun setupDefaultIcons() {
        val deleteIcon = BitmapDrawIcon(
            ContextCompat.getDrawable(context, R.drawable.ic_delete_draw), DrawKey.BOTTOM_LEFT
        )
        ...
        val flipIcon = BitmapDrawIcon(
            ContextCompat.getDrawable(context, R.drawable.ic_flip_draw), DrawKey.TOP_RIGHT
        )
        flipIcon.event = FlipEvent()

        val editIcon = BitmapDrawIcon(
            ContextCompat.getDrawable(context, R.drawable.ic_delete_draw), DrawKey.TOP_LEFT
        )
